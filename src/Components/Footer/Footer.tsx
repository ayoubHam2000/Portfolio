  ...
  return (
    <footer className='pt-20 sm:pt-30 pb-8 mt-20 border-t-2 border-color-primary mx-6 xl:mx-36 text-2xl'>
      <div className='flex flex-col justify-center items-center gap-3'>
        ...
        <div className='flex gap-10 sm:gap-20 my-4 text-[1.5em]' >
        ...
        <div className='flex flex-col xl:flex-row gap-2 xl:gap-20 roboto_font' >
          <div className='text-center text-[0.8em] sm:text-[1em]'> {profileService.phoneNumber} </div>
          <div className='text-center text-[0.8em] sm:text-[1em]'> {profileService.email} </div>
          <div className='text-center text-[0.8em] sm:text-[1em]'> {profileService.address.country} </div>
        </div>
